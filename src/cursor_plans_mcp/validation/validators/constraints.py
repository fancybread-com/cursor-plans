...
class ConstraintValidator(BaseValidator):
    ...
    async def _apply_constraint(self, constraint: Dict[str, Any], plan_data: Dict[str, Any], plan_file_path: str, result: ValidationResult):
    ...
    def _validate_phase_constraint(self, constraint: Dict[str, Any], plan_data: Dict[str, Any], plan_file_path: str, result: ValidationResult, severity: str):
    ...
    def _validate_resource_constraint(self, constraint: Dict[str, Any], plan_data: Dict[str, Any], plan_file_path: str, result: ValidationResult, severity: str):
    ...
    def _validate_architecture_constraint(self, constraint: Dict[str, Any], plan_data: Dict[str, Any], plan_file_path: str, result: ValidationResult, severity: str):
        """Validate architecture-related constraints."""
        # Custom architecture constraints would be implemented here
        pass

    def _validate_dependency_constraint(self, constraint: Dict[str, Any], plan_data: Dict[str, Any], plan_file_path: str, result: ValidationResult, severity: str):
